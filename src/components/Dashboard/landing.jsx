...
function Landing(){
    ...
    return <>
        ...
        {state ? <div className="block md:grid md:grid-cols-2 md:place-items-center">
            ...
            <div className="w-9/12 md:h-80 h-48 md:hover:bg-green-100 m-2 bg-slate-300 rounded-xl bg-hero-pattern">
                <div className="text-3xl font-bold m-2">Your Info</div>

            </div>
            <a href="/ins">
            <div className="w-11/12 md:h-80 h-48  md:hover:bg-green-100 m-2 bg-slate-300 rounded-xl bg-prediction-pattern">
